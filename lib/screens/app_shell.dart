...
class _AppShellState extends State<AppShell> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tab.addListener(() {
      if (!_tab.indexIsChanging && mounted && _currentTab != _tab.index) {
        setState(() {
              ...
              children: [
                SizedBox(
                  ...
                  child: FilledButton.icon(
                    ...
                    label: const Text('Start Free Vision Test'),
                ...
                SizedBox(
                  ...
                  child: FilledButton.icon(
                    ...
                    label: const Text('Start Color Vision Test'),
            ...
            Wrap(
              ...
              children: [
                OutlinedButton.icon(
                  ...
                  label: const Text('Free Online Eye Test'),
                ),
                ...
                OutlinedButton.icon(
                  ...
                  icon: const Icon(Icons.open_in_new),
                  label: const Text('Visual Acuity Test'),
                ),
                ...
                OutlinedButton.icon(
                  ...
                  icon: const Icon(Icons.open_in_new),
                  label: const Text('Accessible Vision Test'),
                ),
              ],
            ),
        ...
        child: ListView(
          ...
          children: [
            ...
            _step(
              ...
              body:
                  'Distance screening checks how clearly you can see using a viewing distance calculated for your calibrated screen. '
